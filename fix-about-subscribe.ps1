...
<body>
    ...
    <div class="container content">
        ...
        <div class="sectors-grid">
            ...
            <div class="sector-tag">🍽️ F&B Management</div>
    ...
    <footer>
        ...
        <p>© 2026 JobLynk.live — Premier Digital Platform for Hospitality & Maritime Careers</p>
        <p style="margin-top:10px;">Founded by Nigel Thomas — 30+ years cruise ships, resorts in Middle East, USA, and India | <a href="https://nigelthomas.live" target="_blank" style="color:#fbbf24;">nigelthomas.live</a></p>
    </footer>
...
[System.IO.File]::WriteAllText("$root\js\subscribe.js", $subscribeJs, $utf8NoBom)

Write-Host "Done. New file sizes:"
Get-Item "$root\about.html" | Format-List FullName, Length
Get-Item "$root\js\subscribe.js" | Format-List FullName, Length
